...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='C:/sfu/vc1project/yolo/ultralytics/ultralytics/data_split', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='YOLO',
...
def main(args):
    ...
    test_stats = evaluate(data_loader_val, model, device, wandb)
